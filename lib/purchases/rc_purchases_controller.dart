...
class RCPurchaseController extends PurchaseController {
  ...
  Future<void> configureAndSyncSubscriptionStatus() async {
    ...
    PurchasesConfiguration configuration = Platform.isIOS
        ? PurchasesConfiguration(Env.revenueCatApiKeyApple)
        : PurchasesConfiguration(Env.revenueCatApiKeyGoogle);
    ...
    Purchases.addCustomerInfoUpdateListener((customerInfo) {
      ...
      bool hasActiveSubscription = customerInfo.entitlements.active
          .isNotEmpty; // Why? -> https://www.revenuecat.com/docs/entitlements#entitlements
  ...
  Future<PurchaseResult> purchase(String productId) async {
    try {
      ...
      if (errorCode == PurchasesErrorCode.paymentPendingError) {
        ...
        return PurchaseResult.failed(e as String);
      }
    }
  }
  ...
  Future<RestorationResult> restorePurchases() async {
    try {
      ...
      return RestorationResult.failed(e as String);
    }
  }
}
